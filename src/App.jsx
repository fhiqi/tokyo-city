...
const App = () => {
  ...
  const NighttransitontwoRef = useRef(null);
  ...
  const sections = useMemo(() => [
    ...
    { id: 'threecard', ref: NightmodeRef, component: <Nightmode /> },
    { id: 'threecard', ref: NighttransitontwoRef, component: <Nighttransitontwo /> },
  ], []);
