...
export function initAnimations() {
  ...
  sun.to("#bg_grad", { attr: { cy: "330" } }, 0.00)
    .to("#sun", { attr: { offset: "0.15" } }, 0.00)
    .to("#bg_grad stop:nth-child(2)", { attr: { offset: "0.15" } }, 0.00)
    .to("#bg_grad stop:nth-child(3)", { attr: { offset: "0.18" } }, 0.00)
    .to("#bg_grad stop:nth-child(4)", { attr: { offset: "0.25" } }, 0.00)
    .to("#bg_grad stop:nth-child(5)", { attr: { offset: "0.46" } }, 0.00)
    ...
    // Scroll Back text
        .fromTo("#arrow2", { opacity: 0 }, { opacity: 0.7, y: -710 }, 0.25)
        .fromTo("#text2", { opacity: 0 }, { opacity: 0.7, y: -710 }, 0.3)
