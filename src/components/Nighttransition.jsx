...
const Nighttransiton = () =>{
    return(
        <div className="flex-col bg-black grid font-['Figtree']">
            <div id="transition1" className="place-self-center bg-black ml-2 bg-contain w-[80%] h-[228px]" style={{backgroundImage: `url(${nigtMode})`}}>
            </div>
